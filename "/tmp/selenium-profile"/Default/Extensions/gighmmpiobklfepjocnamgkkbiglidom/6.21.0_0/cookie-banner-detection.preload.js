...
;// CONCATENATED MODULE: ./adblock-betafish/ipm/cookie-banner-detection/shared/cookie-banner-detection.types.ts
const detectionEventName = "CookieBannerDetected";
const detectionMessage = "cookie-banner.detected";

;// CONCATENATED MODULE: ./adblock-betafish/ipm/cookie-banner-detection/content/cookie-banner-detection.ts


function forwardDetectionEvent() {
    void browser_polyfill_default().runtime.sendMessage({ type: detectionMessage });
}
function start() {
...
;// CONCATENATED MODULE: ./adblock-betafish/ipm/cookie-banner-detection/content/index.ts
